...
<html>
    ...
    <body>
        ...
        <div id="show-marker" class="content scaffold-show" role="main">
            ...
            <f:display bean="marker" />
            <g:form resource="${this.marker}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.marker}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
